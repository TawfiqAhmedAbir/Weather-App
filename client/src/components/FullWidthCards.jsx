  ...
  return (
    <section className="mx-3 mt-3 space-y-2 pb-2">
      ...
      >
        ...
        <span className="text-base font-extrabold text-white">What&apos;s on</span>
      </PressableCard>

      <PressableCard
        onClick={onOpenSupport}
        className="block w-full rounded-2xl bg-primary p-4 shadow-card"
      >
        <span className="text-base font-extrabold text-white">Student support</span>
      </PressableCard>

      <PressableCard
        onClick={onOpenNews}
        className="block w-full rounded-2xl bg-secondary p-4 shadow-card"
      >
        <span className="text-base font-extrabold text-white">News and notices</span>
      </PressableCard>
